...
"""
    ...
    if not deep_info:
        ...
        output_section = """
3. **Output Format**: You MUST respond with ONLY the JSON output. Do NOT include any explanatory text, markdown formatting, code blocks, or additional commentary before or after the JSON.
